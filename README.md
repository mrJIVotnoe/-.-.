...
- [x] **Q3 2026:** Выпуск MVP с виртуализацией списков судов (`@tanstack/react-virtual`), картой Залива Петра Великого и модулем «Цифровой Капитан» (Gemini AI Engine).
- [x] **Q3 2026:** Внедрение верификации email по стандартам РФ (152-ФЗ/547-ФЗ), Flash Call звонок-сброс и двухрежимной авторизации.
- [x] **Q4 2026:** Единый REST API диспетчеризации заявок (`/api/v1/bookings`), серверный термнал генерации QR СБП (НСПК / Т-Банк / Сбер) и движок экспорта/импорта состояния платформы (`/api/v1/export-data`).
- [ ] **Q1 2027:** Миграция БД на реплицируемый кластер PostgreSQL (Yandex Managed Service for PostgreSQL) и юридическое оформление договора с эквайером.
